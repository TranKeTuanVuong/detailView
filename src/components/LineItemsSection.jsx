...
export default function LineItemsSection({
  ...
  if (!lineItemsPanels || lineItemsPanels.length === 0) return null;
  ...
  return (
    <>
      {lineItemsPanels.map((panel) => {
        ...
        // 🔥 Khắc phục lỗi Scope: Đảm bảo biến isTableFieldReadOnly nằm đúng vị trí trong useMemo
        const columns = useMemo(() => {
          return [
            ...
            ...Object.entries(groupedFields).map(([fieldKey, fields]) => {
              ...
              // 🔥 ĐƯA KHAI BÁO LÊN ĐẦU VÒNG LẶP MAP: Tất cả các case (shipment, discount, text...) bên dưới đều dùng được
